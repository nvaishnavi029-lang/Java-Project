...
public class Main{
    public static void main(String[] args){
        ...
        String str3="Hi";
        String str4="py";
        System.out.println(str1.equals(str4)); //Check content equality of strings
        System.out.println(str1.compareTo(str4)); //Check smaller/greater/equal

        
        
        StringBuffer S1=new StringBuffer("java");//Used to create mutable strings and thread-safe
        ...
        StringBuilder S2 = new StringBuilder("java");//Used to create mutable strings and not thread-safe
